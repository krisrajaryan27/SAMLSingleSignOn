...
function initGrid(){
	   	...
	   	dataGrid.setHeader("&nbsp;,<bean:message key="admin_master.title.resume_type"/>"); 
...
function deleteRecord(id){
    ...
    if (retVal == true) {
		var pars = "resumeTypeId="+id;
		var myAjax = ajaxCall("deleteResumeType.action","get",pars,onDeleteComplete,reportError);
    }
}
