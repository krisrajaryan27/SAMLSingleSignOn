...
<s:form action="saveDesignation" method="POST">
<s:hidden name="designationId" id="designationId"/>
	<div class="popupTop">
		<table class="tblPop">
		   <tr>
			  <td class="header">Designation<span class="star">*</span>:
			  </td>
			  <td>
			  	  <s:textfield id="designationName" name="designationName" size="65" maxLength="250"/>
			  </td>
		  </tr>
		  <tr>
...
function submitForm(){
	var Name = $('designationName').value;
	if(Name.trim()==""){
		alert('Please enter designation');
		return;
	}
	document.saveDesignation.submit();
}

function actionOnLoad(){	
		window.top.setPopTitle('<b>Designation</b>');
}
