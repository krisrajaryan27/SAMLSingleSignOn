...
<div class="contentDivPop" style="width:450px;">
	...
	<div class="popupTop">
		...
		<tr>
			...
			<td>
				<html:text property="skillCategory" name="mastersForm" size="35" styleId="skillCategory"></html:text>
		</tr>
		</table>
	</div>
	<div class="popupBody">
...
<!--
function submitForm(){
	var Name = document.mastersForm.skillCategory.value;
	if(Name.trim()==""){
		return;
	}
...
function actionOnLoad(){
	<logic:equal name="mastersForm" property="subMode" value="<%=MastersConstants.SUB_MODE_ADD%>">
		window.top.setPopTitle('<b>Add Skill Category</b>');
	</logic:equal>
	<logic:equal name="mastersForm" property="subMode" value="<%=MastersConstants.SUB_MODE_EDIT%>">
		window.top.setPopTitle('<b>Edit Skill Category</b>');
	</logic:equal>
}
