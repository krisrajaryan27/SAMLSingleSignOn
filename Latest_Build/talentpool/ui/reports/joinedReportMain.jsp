...
<div class="contentDiv">
	...
	<html:hidden property="mode" value="joinedReport"/>
	...
	<html:hidden property="departmentFilter" name="reportForm"/>
	  ...
	  <tr> 
	    <td><div style="width: 200px;" class="boxTab"><span class="rightC"></span><span class="leftC"></span><bean:message key="report.label.joiner_report_joined" /></div></td> 
	  </tr> 
	</table> 
...
function setSelectedFromCookie(){
	var vals = readCookie('<bean:message key="report.label.joiner_report_joined"/>');
	if(vals!='' && vals!=null){
...
function submitForm(){
	if( validateSetFormFields()){
		createCookie('<bean:message key="report.label.joiner_report_joined"/>', selectedFieldsGrid.getAllItemIds(','), 100);
		var d = new Date();	
