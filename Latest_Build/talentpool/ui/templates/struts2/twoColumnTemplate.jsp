...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="themes/default/defaultBody.css"/>
	...
	<tiles:insertAttribute name="topPane"/>
	  <table border="0" cellpadding="0" cellspacing="0" width="1002">
	    <tr>
	      <td width="218" align="left" valign="top" ><tiles:insertAttribute name="leftPane"/></td>
