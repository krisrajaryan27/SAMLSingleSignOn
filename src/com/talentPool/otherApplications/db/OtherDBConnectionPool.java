...
public class OtherDBConnectionPool implements Runnable{
    ...
    public OtherDBConnectionPool(String driver, String url, String username, String password, int initialConnections, int maxConnections, boolean waitIfBusy) throws SQLException {
        this.driver = driver;
        this.url = url;
    ...
    private void makeBackgroundConnection() {
        ...
        try {
        	...
        	TPLogger.getLogger().debug(GlobalConstants.ERROR,oome);
        }catch(Exception e) {
    ...
    throws SQLException {
        try {
        	...
        	TPLogger.getLogger().debug(GlobalConstants.ERROR,cnfe);
            throw new SQLException("Can't find DB Server  " + driver);            
        }
    }
    
    public Connection reconnect(Connection con) throws SQLException{
