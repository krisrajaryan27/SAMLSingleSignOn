 ...
 *
 */
public class RejectedApplicantFields extends Fields {
	public RejectedApplicantFields() {
		...
		getHeaders().add(new Field(("fld" + counter++), TPLabels.getLabel("position_summary.label.rejected_by")));
		getHeaders().add(new Field(("fld" + counter++), TPLabels.getLabel("position_summary.label.rejected_date")));
		getHeaders().add(new Field(("fld" + counter++), TPLabels.getLabel("master_stages.label.stage_name")));
