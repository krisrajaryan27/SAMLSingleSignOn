 ...
 *
 */
public class LocationExportManager extends ExportManager {
	public List<SimpleDataObject> getData(String ids, PermissionSet permissionSet) throws SQLException {
		...
		try {
			...
			dynParams[0] = "WHERE location_id IN (" + qMarks + ")";
			dq = new DBPreparedQuery("dLocationExportManager_GetData", dynParams);
			int cnt=1;
