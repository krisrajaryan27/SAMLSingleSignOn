 ...
 *
 */
public class InstituteExportManager extends ExportManager {
	public List<SimpleDataObject> getData(String ids, PermissionSet permissionSet) throws SQLException {
		...
		try {
			...
			dynParams[0] = "WHERE tpi.institute_id IN (" + qMarks + ")";
			dq = new DBPreparedQuery("dInstituteExportManager_GetData", dynParams);
			int cnt=1;
