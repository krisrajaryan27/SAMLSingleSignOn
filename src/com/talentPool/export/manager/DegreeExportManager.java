 ...
 *
 */
public class DegreeExportManager extends ExportManager {
	public List<SimpleDataObject> getData(String ids, PermissionSet permissionSet) throws SQLException {
		...
		try {
			...
			dynParams[0] = "WHERE tpd.degree_id IN (" + qMarks + ")";
			dq = new DBPreparedQuery("dDegreeExportManager_GetData", dynParams);
			dq.setString(1, DegreeConstants.TYPE_UG);
			dq.setString(2, DegreeConstants.TYPE_PG);
			int cnt=3;
