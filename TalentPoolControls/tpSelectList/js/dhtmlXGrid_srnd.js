...
//FUNCTION ADDED BY SHIV
 dhtmlXGridObject.prototype.setRowHeight = function(height){
 ...
 this._dload = true;
 //MODIFICATIONS BY SHIV
if(this._rowHeight){
	this._srdh=this._rowHeight;
}else{
	if(!this._srdh)this._srdh=23;
}
 ...
 this._dloadSize=Math.floor(parseInt(this.entBox.style.height)/this._srdh)+20; //shiv 2 is replaced by 20
