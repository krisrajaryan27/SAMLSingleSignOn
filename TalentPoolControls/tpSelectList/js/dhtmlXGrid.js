...
function dhtmlXGridObject(id){
 ...
 this.xHdr.style.borderBottom="1px solid #fff"; //this line is added by shiv
 ...
 if(!this.editor)
{
 ...
 if(type=='cstr'){
 this.rowsCol[sort](function(a,b){
 if(arrTS[a.idd].toLowerCase()==arrTS[b.idd].toLowerCase())
 return 0;
 if(order=="asc"){
...
if(!isValidSession(xml,this.urlToRedirect))return;
}
//END ADDED BY SHIV      
