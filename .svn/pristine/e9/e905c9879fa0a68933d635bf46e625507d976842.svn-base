...
<div class="contentDiv">
	...
	<html:hidden property="mode" value="createMmasterReport"/>
	...
	<html:hidden property="departmentId"/>
	  ...
	  <tr> 
	    <td><div style="width:150px;" class="boxTab"><span class="rightC"></span><span class="leftC"></span><bean:message key="report.label.master_report"/></div></td> 
	  </tr> 
	</table> 
