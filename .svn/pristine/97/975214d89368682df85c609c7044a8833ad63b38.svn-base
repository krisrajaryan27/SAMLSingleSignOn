 ...
 * @since  May 8, 2012
 */
public class ResumeTypeInterceptor implements Interceptor {

	/**
	 * Auto Generated Serial Version Id
	 */
	private static final long serialVersionUID = -6446625402275505397L;
	...
	public String intercept(ActionInvocation invocation) throws Exception {
		ServletActionContext.getRequest().setAttribute("masterType", MastersConstants.MASTER_TYPE_RESUME_TYPE);
