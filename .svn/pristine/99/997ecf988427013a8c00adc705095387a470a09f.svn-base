...
SelectBox.prototype = {
  ...
  //display the div
  show: function() {
	if(Element.getStyle(this.outerBox, 'display')=='none') this.options.onShow(this.oTextBox, this.outerBox);
  ...
  //hide the div	
  hide: function() {
	if(Element.getStyle(this.outerBox, 'display')!='none') this.options.onHide(this.oTextBox, this.outerBox);
