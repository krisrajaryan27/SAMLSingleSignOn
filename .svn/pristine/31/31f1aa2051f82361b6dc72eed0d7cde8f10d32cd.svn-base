...
//	public boolean isPERMISSION_PUBLISH_POSITION_TO_SOCIAL_WEB(){
//		return permissions.get(PermissionConstants.PERMISSION_PUBLISH_POSITION_TO_SOCIAL_WEB);
//	}
	/**
	...
	public boolean isPERMISSION_SOCIAL_MEDIA_ACCESS() {
		return permissions.get(PermissionConstants.PERMISSION_SOCIAL_MEDIA_ACCESS);		
	}
	
	public boolean isPERMISSION_POST_JOB_ON_SOCIAL_MEDIA() {
		return permissions.get(PermissionConstants.PERMISSION_POST_JOB_ON_SOCIAL_MEDIA);		
	}
	
	public boolean isPERMISSION_SHOW_ALL_CANDIDATES() {
		return permissions.get(PermissionConstants.PERMISSION_SHOW_ALL_CANDIDATES);
	}
	
	public boolean isPERMISSION_CHANGE_OTHER_USER_PASSWORD() {
		return permissions.get(PermissionConstants.PERMISSION_CHANGE_OTHER_USER_PASSWORD);
	}
}
