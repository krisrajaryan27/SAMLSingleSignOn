...
<div class="contentDiv">
	...
	<html:hidden property="mode" value="financeCostSheetReport"/>
	...
	<html:hidden property="departmentFilter" name="reportForm"/>
	  ...
	  <tr> 
	    <td><div style="width: 200px;" class="boxTab"><span class="rightC"></span><span class="leftC"></span><bean:message key="report.label.cost_sheet_finance_report" /></div></td> 
	  </tr> 
	</table> 
