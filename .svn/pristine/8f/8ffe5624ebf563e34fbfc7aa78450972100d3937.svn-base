 ...
 *
 */
public class EmployeeCommunicationManager {
	...
	public EcommunicationData getCommunicationData(String applicantId, String communicationId, String communicationType) {
		EcommunicationData ecommunicationData = new EcommunicationData();
		try {
			SelectionProcessManager selectionProcessManager = new SelectionProcessManager();
			...
			if (communicationData != null) {
				ecommunicationData.setCommunicationText(communicationData.getCommunicationText());
				ecommunicationData.setCommunicationDate(communicationData.getCommunicationDate());
			}
		} catch (Exception e) {
			TPLogger.getLogger().error(e);
		}
		return ecommunicationData;
	}
}
