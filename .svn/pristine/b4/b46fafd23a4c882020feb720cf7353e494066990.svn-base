...
<div class="contentDiv">
	...
	<html:hidden property="mode" value="oneStopFileReport"/>
	...
	<html:hidden property="departmentFilter" name="reportForm"/>
	  ...
	  <tr> 
	    <td><div style="width: 200px;" class="boxTab"><span class="rightC"></span><span class="leftC"></span><bean:message key="report.label.one_stop_file_report" /></div></td> 
	  </tr> 
	</table> 
