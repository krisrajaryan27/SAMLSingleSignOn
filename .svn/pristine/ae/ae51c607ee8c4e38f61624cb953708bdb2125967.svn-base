...
@echo on
java org.apache.axis.client.AdminClient -lhttp://localhost:8080/tp/servlet/AxisServlet -h localhost -p 8080 D:\Projects\talentpool\Trunk\build\com\talentPool\services\deploy.wsdd
