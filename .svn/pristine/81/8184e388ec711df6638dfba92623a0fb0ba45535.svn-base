 ...
 * 
 */
package com.talentPool.user.constants;
...
public class PermissionConstants {
	...
	/* ADMIN */
	public static final int PERMISSION_CUSTOM_FIELDS = 70;
	
	public static final int PERMISSION_LABEL_MESSAGES = 69;
	...
	public static final int PERMISSION_SOCIAL_MEDIA_ACCESS=98;
	
	public static final int PERMISSION_POST_JOB_ON_SOCIAL_MEDIA=99;
	//public static final int PERMISSION_PUBLISH_POSITION_TO_SOCIAL_WEB = 100;
	
	public static final int PERMISSION_SHOW_ALL_CANDIDATES = 100;
	
	public static final int PERMISSION_CHANGE_OTHER_USER_PASSWORD = 101;
