...
DECLARE cur_my_applicants CURSOR FOR 
	...
	tps.position_step_isscheduled, tpsu.is_responsible_for_scheduling, tpsu.is_authorized_to_move,
...
REPEAT
	...
	v_position_step_isscheduled, v_is_responsible_for_scheduling, v_is_authorized_to_move,
