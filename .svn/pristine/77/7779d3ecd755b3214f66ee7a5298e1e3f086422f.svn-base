...
<div class="contentDivPop" style="width:440px;">
	<html:form action="/importResume" enctype="multipart/form-data" target="subForm">
		...
		<table class="tblPop" width="100%">
		  <tr>
			<td>Select file: 
				...
				<td>
					<html:file property="attachedFile" name="applicantForm" style="width:340px;height:20px; " value=""></html:file>  
				</td>
			</tr>
		</table>
	</div>
...
function fileUploaded(error,attachmentId, originalFileName, attachmentSize, labeledAttachmentSize, filePath){
	...
	if(error != '') {
		...
		document.forms['applicantForm'].attachedFile.value='';	
