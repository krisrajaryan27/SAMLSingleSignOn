...
<html:hidden property="reportType"/>
	  ...
	  <tr> 
	    <td><div style="width:160px;" class="boxTab"><span class="rightC"></span><span class="leftC"></span><bean:message key="hiring_funnel_report.label.title"/></div></td> 
	  </tr> 
	</table> 
						...
						<div id="divSelectDateRange" style="display:none;">
					 		 <table class="innerReport" cellspacing="0" cellpadding="0" border="0" >
				      	 		<tr>
				      	 			...
				      	 			<td>
	  		        		  			<bean:message key="report.label.select" /> :
...
//first do the validations
	...
	if(document.reportForm.reportType.value==<%=ReportConstants.REPORT_TYPE_SUMMARY%>){
		document.reportForm.mode.value = 'hiringFunnelSummaryReport';
