...
<body>
<s:form name="userScheduler" method="POST" action="saveUserSchedulerProperties" >
...
<div class="contentDiv">
	<div class="boxTab" style="width:200px;"><span class="rightC"></span><span class="leftC"></span><s:text name="admin.user_scheduler.properties" /></div>
		...
		<table class="posinput" width="100%" style="padding: 15px 0px 15px 30px;"> 
		  <tr>
		  	 <td class="label" width="100px">
			 	<s:text name="admin.user_scheduler.start_hour" /> 
			 </td>
			 <td>
			 	: &nbsp;&nbsp;
			 		<script>
		  ...
		  <tr>
		  	 <td class="label" width="100px">
				<s:text name="admin.user_scheduler.frequency" /> 
			 </td>
			 <td>
			 	: &nbsp;&nbsp;
			 		<script>
	...
	<br/><br/><br/><br/>
	<div class="boxTab" style="width:200px;"><span class="rightC"></span><span class="leftC"></span><s:text name="admin.user_scheduler.last_run_details" /></div>
	<div class="outerDiv" style="width: 350px;" >
		<table class="posinput" width="100%" style="padding: 15px 0px 15px 30px;"> 
		  <tr>
		  	 <td class="label" width="100px">
			 	<s:text name="admin.user_scheduler.last_status" /> 
			 </td>
			 <td>
		  ...
		  <tr>
		  	 <td class="label" width="100px">
				<s:text name="admin.user_scheduler.last_start_time" /> 
			 </td>
			 <td>
		  ...
		  <tr>
		  	 <td class="label" width="100px"> 
			 	<s:text name="admin.user_scheduler.last_end_time" />
			 </td>
			 <td>
	...
	<table width="350px" style="padding: 15px 0px 15px 30px;">
		<tr>
			<td class="label" width="100px">
			 	<s:text name="admin.user_scheduler.current_status" /> 
			</td>
			<td id="curStat">
				...
				<div id="wait">
					<s:if test="#curStatus == 'IDLE'">
				 		<div id="runNowBtn" class="navBtn" style="float: right;margin-top: 5px;">
							<a href="#" style="width:100px; margin-left:5px;" class="active" onclick="javascript: runNow();"><span class="rightC"></span><span class="leftC"></span><s:text name="admin.user_scheduler.run_now"/></a>
						</div>	
					</s:if>
				</div>
			</td>	
...
function save(){
	document.userScheduler.startHour.value = selectBoxStartHour.getSelectedId();
	document.userScheduler.frequency.value = selectBoxFrequency.getSelectedId();
	document.userScheduler.submit();
}

function runNow(){
	showUpdater('wait',{setHeight: false, setWidth: false, offsetLeft: 0});
	$('curStat').replace(': &nbsp;&nbsp;RUNNING');
	document.userScheduler.action='runUserScheduler.action';
	document.userScheduler.submit();
}
