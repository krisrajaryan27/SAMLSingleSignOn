...
<div class="contentDiv">
	...
	<html:hidden property="mode" value="positionSummaryReport"/>
	...
	<html:hidden property="dateRange" name="reportForm"/>
	  ...
	  <tr> 
	    <td><div style="width:170px;" class="boxTab"><span class="rightC"></span><span class="leftC"></span>Position Summary Report</div></td> 
	  </tr> 
	</table> 
	                 ...
	                 <tr>
	  			 		<td width="100%" colspan="2">
							<div id="divSelectSpecificPosition" style="display:none;">
							         ...
							         <script type="text/javascript">
								       var opts = new Array();
								       selectPosition = new SelectBox(new Array(),'','images/btn_dropdown.gif',{namesonly:false, width:'200px', size:20});
