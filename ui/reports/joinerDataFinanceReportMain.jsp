...
<div class="contentDiv">
	...
	<html:hidden property="mode" value="joinerDataFinanceReport"/>
	...
	<html:hidden property="departmentFilter" name="reportForm"/>
	  ...
	  <tr> 
	    <td><div style="width: 200px;" class="boxTab"><span class="rightC"></span><span class="leftC"></span><bean:message key="report.label.joiner_data_finance_report" /></div></td> 
	  </tr> 
	</table> 
