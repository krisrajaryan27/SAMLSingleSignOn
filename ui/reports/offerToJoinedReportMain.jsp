...
<div class="contentDiv">
	...
	<html:hidden property="dateRange" name="reportForm"/>
	  ...
	  <tr> 
	    <td><div style="width:150px;" class="boxTab"><span class="rightC"></span><span class="leftC"></span>Offer to Joined Report</div></td> 
	  </tr> 
	</table> 
