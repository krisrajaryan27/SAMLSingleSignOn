...
<div class="contentDiv">
	...
	<html:hidden property="reportName" name="reportForm"/>
	<html:hidden property="departmentId" name="reportForm"/>
	<html:hidden property="positionId" name="reportForm"/>
	<html:hidden property="mode" value="indiaHiringSummaryReport"/>
	...
	<html:hidden property="selectedUserIds"/>
	  ...
	  <tr> 
	    <td><div style="width: 200px;" class="boxTab"><span class="rightC"></span><span class="leftC"></span><bean:message key="report.label.india_hiring_summary_report" /></div></td> 
	  </tr> 
	</table> 
