...
<div class="contentDiv">
	...
	<html:hidden property="dateRange" name="reportForm"/>
	  ...
	  <tr> 
	    <td><div style="width:160px;" class="boxTab"><span class="rightC"></span><span class="leftC"></span><bean:message key="report.label.candidate_offers"/></div></td> 
	  </tr> 
	</table> 
			...
			<td>
				<table class="innerReport" width="100%">
					<tr>
	 			    ...
	 			    <tr>
		                 <td  class="firstColumn" width="100%" colspan="2">
		                   ...
		                   <script type="text/javascript">
				                    ...
				                    selectFilter = new SelectBox(opts,'<%=ReportConstants.FILTER_ALL_POSITIONS%>','images/btn_dropdown.gif',{namesonly:false, width:'172px', size:20});
	                 ...
	                 <tr>
	  			 		<td width="100%" colspan="2">
							<div id="divSelectSpecificPosition" style="display:none;">
							         ...
							         <script type="text/javascript">
								       var opts = new Array();
								       selectPosition = new SelectBox(new Array(),'','images/btn_dropdown.gif',{namesonly:false, width:'150px', size:20});
...
function validateSetFormFields(){
	...
	document.reportForm.mode.value = 'candidateOffersReport';
