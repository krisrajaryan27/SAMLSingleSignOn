...
<div class="contentDivPop" style="width:450px;">
	...
	<html:form action="/masters" onsubmit="submitForm();return false;">
  	<html:hidden property="branchId" name="mastersForm"/>
	...
	<div class="popupTop">
		<table class="tblPop">
		   <tr>
			  <td class="header">
				  <bean:message key="admin_master_branch_cat.label"/>
				  <span class="star">*</span>
				  :
			  </td>
			  <td>
				  <html:text property="branchName" name="mastersForm" size="35" maxlength="98" styleId="skillCategory"></html:text>
			  </td>
		  </tr>
		  <tr>
			  <td class="header">
			  ...
			  <td>
				 <html:text property="aliases[0]" name="mastersForm" size="35" styleId="aliases[0]"></html:text>
		     </td>
		 </tr>
		 <tr>
			 <td class="header">
			 ...
			 <td>
				<html:text property="aliases[1]" name="mastersForm" size="35" styleId="aliases[1]"></html:text>
			 </td>
		</tr>
		<tr>
			 <td class="header">
...
function submitForm(){
	var Name = document.mastersForm.branchName.value;
	if(Name.trim()==""){
		return;
	}
	//alert('submit');	
