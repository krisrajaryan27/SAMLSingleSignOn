...
<div class="contentDivPop" style="width:450px;">
	...
	<div class="popupTop">
		...
		<tr>
			<td class="header">
				<bean:message key="admin_master_source.label.add_new_source_type"/>
				<span class="star">*</span>
				:
			</td>
			<td>
				<html:text property="sourceTypeName" name="mastersForm" size="35" styleId="sourceTypeName"></html:text>
		</tr>
		</table>
	</div>
	<div class="popupBody">
...
<!--
function submitForm(){
	var Name = document.mastersForm.sourceTypeName.value;
	if(Name.trim()==""){
		return;
	}
...
function actionOnLoad(){
	<logic:equal name="mastersForm" property="subMode" value="<%=MastersConstants.SUB_MODE_ADD%>">
		window.top.setPopTitle('<b>Add Source Category</b>');
	</logic:equal>
	<logic:equal name="mastersForm" property="subMode" value="<%=MastersConstants.SUB_MODE_EDIT%>">
		window.top.setPopTitle('<b>Edit Source Category</b>');
	</logic:equal>
}
