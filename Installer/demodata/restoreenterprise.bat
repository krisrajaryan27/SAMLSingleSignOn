...
xcopy c:\demodata\enterprise.lic %TALENTPOOL_PATH%\license\license.lic /K /Y
...
::xcopy c:\demodata\enterprise.lic "C:\Program Files\TalentPool\license\license.lic" /K /Y
